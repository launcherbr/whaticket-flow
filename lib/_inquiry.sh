...
#  
#  print_banner
#  printf "${WHITE} 💻 Insira o link do GITHUB do Flowlatest que deseja instalar:${GRAY_LIGHT}"
#  printf "\n\n"
#  read -p "> " link_git
#}
...
inquiry_options() {
  ...
  print_banner
  printf "${WHITE} 💻 Bem vindo(a) ao Gerenciador de instalação automatico, Flowlatest. Selecione abaixo a proxima ação!${GRAY_LIGHT}"
  printf "\n\n"
  printf "   [0] Instalar Flowlatest\n"
  printf "   [1] Atualizar Flowlatest\n"
  printf "   [2] Deletar Flowlatest\n"
  printf "   [3] Bloquear Flowlatest\n"
  printf "   [4] Desbloquear Flowlatest\n"
  printf "   [5] Alter. dominio Flowlatest\n"
  printf "\n"
  read -p "> " option
